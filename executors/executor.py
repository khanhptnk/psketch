...
class Executor(object):
    ...
    def init(self, srcs, tasks, is_eval):
        ...
        task_encodings, task_masks = self._index_and_pad(tasks, self.task_vocab)
    ...
    def act(self, gold_actions=None):
    ...
    def predict(self, src_words, tasks):
        ...
        self.init(src_words, tasks, True)
