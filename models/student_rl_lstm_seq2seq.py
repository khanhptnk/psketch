...
class StudentRLLSTMSeq2SeqModel(nn.Module):

    def __init__(self, config):

        super(StudentRLLSTMSeq2SeqModel, self).__init__()
    ...
    def decode(self, prev_action):
        ...
        self.feature = torch.cat(
            [output, attended_task_h, attended_src_h], dim=1)
        logit = self.predictor(self.feature)
    ...
    def predict_baseline(self):
        return self.baseline_predictor(self.feature.detach())
